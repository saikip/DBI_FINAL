...
void q1 () {
	...
	char *pred_ps = "(ps_supplycost < 1.03)"; // 0 recs 
	// 3674 4051
	//char *pred_ps = "(ps_supplycost < 500.00)"; // 4051 records 
...
void q2 () {
	...
	// 61 records
	//char *pred_p = "(p_retailprice > 100.01) AND (p_retailprice < 930.3)"; 
	//char *pred_p = "(p_retailprice > 100.00)"; // 2000 records
	//char *pred_p = "(p_retailprice < 100.00)"; // 0 records
...
void q3 () {
	...
	Sum T;
		...
		Function func;
			...
			// 420977
			//char *str_sum = "(s_acctbal + (s_acctbal * 0.05))";
...
void q5 () {
	//  100
	char *pred_ps = "(ps_supplycost < 100.11)"; // 802 recs - non distinct
	// 17
	//char *pred_ps = "(ps_supplycost > 100.00) AND (ps_supplycost < 105.00)"; // 43 recs - non distinct
	init_SF_ps (pred_ps, 100);
