...
public:
	PartialSortedDBFileMock(File &file, Input &rfile, Settings &config, ComparisonEngine &comp, char *f_path, SortInfo *sortInfo);
...
public:
	...
	StrictMock<MockSettings> config;
	StrictMock<MockInput> rfile;
	...
	void SetSequentialProcessor(SequentialProcessor *scanner) { sorteddb->scanner = scanner; }
